...
2. Navigate to [192.168.2.2:2770/network](http://192.168.2.2:2770/network) in an internet browser (Chrome, Edge, Firefox, etc.) and ensure that the vehicle has access to a WiFi network. If you do not see a webpage at this address, verify the network settings are correct. Troubleshooting steps can be found here.
...
1. Open QGroundControl and navigate **Firmware** page.
...
1. Go the **Frame Setup** page.
2. Click on the corresponding vehicle frame that was originally picked out in the "Building a Vehicle Frame" section of this documentation.
...
1. Go to the **Sensors** tab in the sidebar on the left.
...
1. The output channel for the lights is configured in the **Lights** tab.
