...
Please paste the page's main content (the article/body) you want converted, and I will:

- Convert package-manager install blocks into tabs (npm/yarn/pnpm).
- Turn multi-step numbered lists into a stepper.
