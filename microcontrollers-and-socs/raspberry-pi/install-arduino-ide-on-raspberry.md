...
### How to install Arduino IDE on Raspberry Pi <a href="#how-to-install-arduino-ide-on-raspberry-pi-part-2" id="how-to-install-arduino-ide-on-raspberry-pi-part-2"></a>
