...
_If you come across any mistakes or bugs in this tutorial, please let us know using a Github issue, a post on the DJI forum. Please feel free to send us Github pull request and help us fix any issues. However, all pull requests related to document must follow the_ [_document style_](https://github.com/dji-sdk/Mobile-SDK-Tutorial/issues/19)
...
>
> For more details of applying for an DJI App, please check this link for details: [https://developer.dji.com/mobile-sdk/get-started/Register-Download/](https://developer.dji.com/mobile-sdk/get-started/Register-Download/)
...
Then select "Blank Activity" and press Next. Lastly, leave the **Activity Name** as "MainActivity", the **Layout Name** as "activity\_main", the **Title** as "MainActivity", and the **Menu Resource Name** as "menu\_main". Press "Finish" to create the project.

### Downloading and Importing Module to the Project <a href="#downloading-and-importing-module-to-the-project" id="downloading-and-importing-module-to-the-project"></a>
...
### Configurating the Gradle File <a href="#configurating-the-gradle-file" id="configurating-the-gradle-file"></a>
...
### Trying to use Android SDK in the Project <a href="#trying-to-use-android-sdk-in-the-project" id="trying-to-use-android-sdk-in-the-project"></a>
...
#### Registering the Application <a href="#registering-the-application" id="registering-the-application"></a>
