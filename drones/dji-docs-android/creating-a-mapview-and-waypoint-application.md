...
* [Using The DJI PC Simulator](broken-reference)
  ...
  * [2. Installing and setup the DJI PC Simulator](broken-reference)
  * [3. Using the DJI PC Simulator](broken-reference)
* [Upgrading Your Aircraft's Firmware](broken-reference)
* [Setup The Map View](broken-reference)
  * [1. Importing The Framework and Libraries](broken-reference)
  * [2. Creating the Map View](broken-reference)
  * [3. Adding Annotations to the MapView](broken-reference)
  * [4. Focusing the MKMapView](broken-reference)
  * [5. Showing the Aircraft on Map View](broken-reference)
* [Refactoring the UI](broken-reference)
  * [1. Adding & Handling the New UIButtons](broken-reference)
* [Configuring DJIWaypoint and DJIWaypointMission](broken-reference)
  * [DJIWaypoint](broken-reference)
  * [DJIWaypointMission](broken-reference)
  * [Creating The DJIWaypointConfigViewController](broken-reference)
* [Implementing the DJIWaypoint Mission](broken-reference)
  * [Adding the DJIWaypointConfigViewController to DJIRootViewController](broken-reference)
  * [Handling The DJIWaypoint Mission](broken-reference)
* [Showtime](broken-reference)
...
#### 2. Installing and setup the DJI PC Simulator <a href="#id-2-installing-and-setup-the-dji-pc-simulator" id="id-2-installing-and-setup-the-dji-pc-simulator"></a>
...
#### 3. Using the DJI PC Simulator <a href="#id-3-using-the-dji-pc-simulator" id="id-3-using-the-dji-pc-simulator"></a>
...
### Upgrading Your Aircraft's Firmware <a href="#upgrading-your-aircrafts-firmware" id="upgrading-your-aircrafts-firmware"></a>
...
#### 1. Importing The Framework and Libraries <a href="#id-1-importing-the-framework-and-libraries" id="id-1-importing-the-framework-and-libraries"></a>
...
#### 2. Creating the Map View <a href="#id-2-creating-the-map-view" id="id-2-creating-the-map-view"></a>
...
### Refactoring the UI <a href="#refactoring-the-ui" id="refactoring-the-ui"></a>
...
#### 1. Adding & Handling the New UIButtons <a href="#id-1-adding--handling-the-new-uibuttons" id="id-1-adding--handling-the-new-uibuttons"></a>
...
### Configuring DJIWaypoint and DJIWaypointMission <a href="#configuring-djiwaypoint-and-djiwaypointmission" id="configuring-djiwaypoint-and-djiwaypointmission"></a>

#### DJIWaypoint <a href="#djiwaypoint" id="djiwaypoint"></a>
...
#### DJIWaypointMission <a href="#djiwaypointmission" id="djiwaypointmission"></a>
...
#### Creating The DJIWaypointConfigViewController <a href="#creating-the-djiwaypointconfigviewcontroller" id="creating-the-djiwaypointconfigviewcontroller"></a>
...
### Implementing the DJIWaypoint Mission <a href="#implementing-the-djiwaypoint-mission" id="implementing-the-djiwaypoint-mission"></a>

#### Adding the DJIWaypointConfigViewController to DJIRootViewController <a href="#adding-the-djiwaypointconfigviewcontroller-to-djirootviewcontroller" id="adding-the-djiwaypointconfigviewcontroller-to-djirootviewcontroller"></a>
...
### Showtime <a href="#showtime" id="showtime"></a>
