...
* [Robotics](robotics/README.md)
  ...
  * [ArduSub](robotics/ardusub/README.md)
    * [Troubleshooting](robotics/ardusub/troubleshooting.md)
    * [Overview](robotics/ardusub/overview.md)
    * [Installing Autopilot Firmware](robotics/ardusub/installing-autopilot-firmware.md)
    * [Sensors Setup Page](robotics/ardusub/sensors-setup-page.md)
    * [Features](robotics/ardusub/features.md)
    * [Frame Setup Page](robotics/ardusub/frame-setup-page.md)
    * [Building a Vehicle Frame](robotics/ardusub/building-a-vehicle-frame.md)
    * [Power Setup Page](robotics/ardusub/power-setup-page.md)
    * [Motors Setup Page](robotics/ardusub/motors-setup-page.md)
    * [Camera Mount Setup Page](robotics/ardusub/camera-mount-setup-page.md)
    * [Safety Setup Page (Failsafes)](robotics/ardusub/safety-setup-page-failsafes.md)
    * [Data Logging](robotics/ardusub/data-logging.md)
    * [Lights Setup Page](robotics/ardusub/lights-setup-page.md)
    * [Applications](robotics/ardusub/applications.md)
    * [Installing Companion Software Image](robotics/ardusub/installing-companion-software-image.md)
    * [Joystick Setup Page](robotics/ardusub/joystick-setup-page.md)
    * [Parameters Page](robotics/ardusub/parameters-page.md)
    * [Autopilot](robotics/ardusub/autopilot.md)
    * [Required Hardware](robotics/ardusub/required-hardware.md)
    * [QGroundControl Software](robotics/ardusub/qgroundcontrol-software.md)
    * [Firmware Page](robotics/ardusub/firmware-page.md)
