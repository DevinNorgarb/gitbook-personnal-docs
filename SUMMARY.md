...
- [Home](README.md)
  ...
  - [Install Scripts](snippets-and-scripts/install-scripts/README.md)
    ...
    - [n8n](snippets-and-scripts/install-scripts/n8n.md)
    - [PiVPN](snippets-and-scripts/install-scripts/pivpn.md)
    - [act (Install GitHub Runners Locally)](snippets-and-scripts/install-scripts/act-install-github-runners-locally.md)
    - [Composer](snippets-and-scripts/install-scripts/composer.md)
    - [Python + Libraries](snippets-and-scripts/install-scripts/python-libraries/README.md)
      - [poetry](snippets-and-scripts/install-scripts/python-libraries/poetry/README.md)
      - [pyenv](snippets-and-scripts/install-scripts/python-libraries/pyenv/README.md)
    - [HTTPie](snippets-and-scripts/install-scripts/httpie.md)
    - [Yarn](snippets-and-scripts/install-scripts/yarn.md)
    - [esp-idf](snippets-and-scripts/install-scripts/esp-idf.md)
    ...
    - [ZeroTier VPN](snippets-and-scripts/install-scripts/zerotier-vpn.md)
    - [Mac OS](snippets-and-scripts/install-scripts/mac-os.md)
    - [Samba on Mac](snippets-and-scripts/install-scripts/samba-on-mac.md)
    - [Pritunl VPN Client](snippets-and-scripts/install-scripts/pritunl-vpn-client.md)
    - [Docker](snippets-and-scripts/install-scripts/install-docker-and-docker-compose/README.md)
    ...
    - [Install NVM](snippets-and-scripts/install-scripts/install-nvm.md)
    - [Install Golang](snippets-and-scripts/install-scripts/install-golang.md)
    - [Install MAGE](snippets-and-scripts/install-scripts/install-mage.md)
...
- [WebAssembly](software-engineering/webassembly/README.md)
  - [Go and WASM](software-engineering/webassembly/go-and-wasm.md)
  - [Shrinking .wasm Code Size](software-engineering/webassembly/shrinking-.wasm-code-size.md)
- [Automation](software-engineering/automation/README.md)
  - [n8n Docs](software-engineering/automation/n8n-docs.md)
  - [Browser](software-engineering/automation/browser/README.md)
    - [Cypress](software-engineering/automation/browser/cypress.md)
    - [Sorry-Cypress](software-engineering/automation/browser/sorry-cypress.md)
    - [Puppeteer](software-engineering/automation/browser/puppeteer.md)
...
- [Authentication](software-engineering/authentication/README.md)
  ...
  - [Logto (logto-io/logto)](software-engineering/authentication/github-logto-io-logto.md)
...
- [PHP](software-engineering/php/README.md)
  ...
  - [Laravel](software-engineering/php/laravel/README.md)
    ...
    - [Inertia Guide](software-engineering/php/laravel/inertia-guide.md)
    - [How to use Lando for local development with Laravel](software-engineering/php/laravel/how-to-use-lando-for-local-development-with-laravel/README.md)
      - [Provision LXC Containers](software-engineering/php/laravel/how-to-use-lando-for-local-development-with-laravel/provision-lxc-containers.md)
      - [Dante in Oracle Cloud](software-engineering/php/laravel/how-to-use-lando-for-local-development-with-laravel/dante-in-oracle-cloud.md)
...
- [Tooling](software-engineering/tooling/README.md)
  - [Testing](software-engineering/tooling-extras/testing/README.md)
    - [Frontend](software-engineering/tooling-extras/testing/frontend/README.md)
      - [Sorry Cypress](software-engineering/tooling-extras/testing/frontend/sorry-cypress.md)
  - [Miscellaneous](software-engineering/tooling/miscellaneous/README.md)
    - [Creating Bootable Drives](software-engineering/tooling-extras/miscellaneous/creating-bootable-drives/README.md)
      - [Ventoy](software-engineering/tooling-extras/miscellaneous/creating-bootable-drives/ventoy.md)
      - [i-Ventoy](software-engineering/tooling-extras/miscellaneous/creating-bootable-drives/i-ventoy.md)
  ...
  - [Backend](software-engineering/tooling/backend/README.md)
    - [Install Certbot](software-engineering/install-certbot/README.md)
...
- [Linux](software-engineering/linux/README.md)
  ...
  - [apt](software-engineering/linux/apt/README.md)
    - [MultiArch apt Sources](software-engineering/linux/apt/multiarch-apt-sources.md)
    - [Ubuntu 22.04 LTS (ARM/RISC-V) (Jammy Jellyfish) -- Full sources.list](software-engineering/linux/apt/ubuntu-22.04-lts-arm-risc-v-jammy-jellyfish-full-sources.list.md)
...
- [Containerisation](software-engineering/containerisation/README.md)
  - [LXC/LXD](software-engineering/containerisation/lxc-lxd/README.md)
    - [Troubleshooting](software-engineering/containerisation/lxc-lxd/troubleshooting.md)
  ...
  - [Hypervisors](software-engineering/containerisation/hypervisors/README.md)
    - [ProxMox](software-engineering/containerisation/hypervisors/proxmox/README.md)
      - [Page 1](software-engineering/containerisation/hypervisors/proxmox/page-1.md)
- [Browsers](software-engineering/browsers/README.md)
  ...
  - [API's](software-engineering/browsers/apis/README.md)
    ...
    - [Browser BarcodeDetect API using Image](software-engineering/browsers/apis/browser-barcodedetect-api-using-image.md)
...
- [Networking](software-engineering/networking/README.md)
  ...
  - [Web Sockets](software-engineering/networking/web-sockets/README.md)
    - [Testing Socket.IO with Postman](software-engineering/networking/web-sockets/testing-socketio-with-postman.md)
  ...
  - [Cloudflare Tunnels](software-engineering/networking/cloudflare-tunnels/README.md)
    - [Configure Cloudflare Tunnel in docker-compose.yml](software-engineering/networking/cloudflare-tunnels/configure-cloudflare-tunnel-in-docker-compose.yml.md)
    - [Cloudflare Tunnel with Docker](software-engineering/networking/cloudflare-tunnels/cloudflare-tunnel-with-docker.md)
  - [PFSense](software-engineering/networking/pfsense/README.md)
    - [Virtualizing with Proxmox® VE](software-engineering/networking/pfsense/virtualizing-with-proxmox-r-ve.md)
  - [Oracle VCN Docs](software-engineering/networking/oracle-vcn-docs/README.md)
    - [Exposing Ports on Oracle Cloud](software-engineering/networking/oracle-vcn-docs/exposing-ports-on-oracle-cloud.md)
    - [Networking Overview](software-engineering/networking/oracle-vcn-docs/networking-overview.md)
...
- [Devops](software-engineering/devops/README.md)
  - [Cloud-Init](software-engineering/devops/cloud-init/README.md)
    - [Cloud-Init Validation](software-engineering/devops/cloud-init/cloud-init-validation.md)
...
- [Guides](obd2/guides/README.md)
  ...
  - [Hackster.io](obd2/guides/hackster.io/README.md)
    ...
    - [IoT4Car](obd2/guides/hackster.io/iot4car.md)
    - [Decentralized Fleet Tracking with Blockchain](obd2/guides/hackster.io/decentralized-fleet-tracking-with-blockchain.md)
...
- [Communication Protocols](robotics/communication-protocols/README.md)
  ...
  - [UART](robotics/communication-protocols/uart.md)
  - [I2C](robotics/communication-protocols/i2c.md)
  - [SPI](robotics/communication-protocols/spi.md)
...
- [ArduSub](robotics/ardusub-overview.md)
...
- [Raspberry Pi](microcontrollers-and-socs/raspberry-pi/README.md)
  - [Diet Pi](microcontrollers-and-socs/raspberry-pi/diet-pi/README.md)
    - [Diet Pi Supported Software](microcontrollers-and-socs/raspberry-pi/diet-pi/diet-pi-supported-software.md)
  - [Kodi](microcontrollers-and-socs/raspberry-pi/kodi/README.md)
    - [Wiki](microcontrollers-and-socs/raspberry-pi/kodi/wiki.md)
  - [SIM800L GPS/GPRS AT Commands](microcontrollers-and-socs/raspberry-pi/sim800l-gps-gprs-at-commands.md)
  - [Use Raspberry Pi as JTAG Debugger](microcontrollers-and-socs/raspberry-pi/use-raspberry-pi-as-jtag-debugger.md)
  - [Install Arduino IDE on Raspberry](microcontrollers-and-socs/raspberry-pi/install-arduino-ide-on-raspberry.md)
  - [Awesome Raspberry Pi](microcontrollers-and-socs/raspberry-pi/awesome-raspberry-pi.md)
  - [Raspberry Pi HotSpot](microcontrollers-and-socs/raspberry-pi/raspberry-pi-hotspot/README.md)
    - [raspap-webgui](microcontrollers-and-socs/raspberry-pi/raspberry-pi-hotspot/raspap-webgui.md)
    - [HotSpotOS](microcontrollers-and-socs/raspberry-pi/raspberry-pi-hotspot/hotspotos.md)
    - [Kupiki-Hotspot-Script](microcontrollers-and-socs/raspberry-pi/raspberry-pi-hotspot/kupiki-hotspot-script.md)
    - [RPI-Wireless-Hotspot](microcontrollers-and-socs/raspberry-pi/raspberry-pi-hotspot/rpi-wireless-hotspot.md)
  ...
  - [Install ProxMox on a Raspberry Pi](microcontrollers-and-socs/raspberry-pi/install-proxmox-on-a-raspberry-pi/README.md)
    ...
    - [Pi My Life Up — PXVirt install](microcontrollers-and-socs/raspberry-pi/install-proxmox-on-a-raspberry-pi/pimylifeup-raspberry-pi-proxmox.md)
...
- [Sentry](self-hosting/sentry/README.md)
...
- [devinn.org → GitHub Pages proxy](self-hosting/devinn-org-github-pages-proxy.md)
...
- [How to Use Mapbox in QGIS](gis/how-to-use-mapbox-in-qgis.md)
...
- [Protocols](ip-cameras/protocols/README.md)
  - [RTSP](ip-cameras/protocols/rtsp/README.md)
    - [Real Time Streaming Protocol (RTSP)](ip-cameras/protocols/rtsp/real-time-streaming-protocol-rtsp.md)
  - [ONVIF](ip-cameras/protocols/onvif.md)
...
- [tutorials](misc/tutorials/README.md)
  ...
  - [From Google Sheets, how to send email based on date](misc/tutorials/from-google-sheets-how-to-send-email-based-on-date/README.md)
    - [Using ChatGPT to build system diagrams — Part II](misc/tutorials/from-google-sheets-how-to-send-email-based-on-date/using-chatgpt-to-build-system-diagrams-part-ii.md)
  - [Feeling Guilty Billing Clients?](misc/tutorials/feeling-guilty-billing-clients/README.md)
    - [marvinferber BLOG](misc/tutorials/feeling-guilty-billing-clients/marvinferber-blog.md)
